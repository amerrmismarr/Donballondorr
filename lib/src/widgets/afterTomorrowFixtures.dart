...
class AfterTomorrowFixtures extends StatefulWidget {
  @override
  _AfterTomorrowFixturesState createState() => _AfterTomorrowFixturesState();
}

class _AfterTomorrowFixturesState extends State<AfterTomorrowFixtures>  {
