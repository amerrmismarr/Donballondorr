...
class YesterdayFixtures extends StatefulWidget {
  @override
  _YesterdayFixturesState createState() => _YesterdayFixturesState();
}

class _YesterdayFixturesState extends State<YesterdayFixtures>  {
