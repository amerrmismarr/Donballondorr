...
class LoginToFavorites extends StatefulWidget {
  StreamSubscription _userSubscription;
  StreamSubscription _errorMessageSubscription;
  @override
  _LoginToFavoritesState createState() => _LoginToFavoritesState();
}

class _LoginToFavoritesState extends State<LoginToFavorites> {

  @override
  void initState() {
    final authBloc = Provider.of<AuthBloc>(context, listen: false);
    widget._userSubscription = authBloc.appUser.listen((user) {
      if(user != null) Navigator.pushReplacementNamed(context, '/favorites');
    });
